...
[Zora](https://github.com/ourzora) was created by a team of artists, engineers, and designers who believe that NFTs can empower creators and revolutionize the way we value and trade digital art. The platform is built on Ethereum, the world's leading blockchain for decentralized applications, and uses smart contracts to enable secure and transparent transactions.
...
If you want to find out more on how to create a NFT Marketplace with best practices 
[contact us](/contact)
