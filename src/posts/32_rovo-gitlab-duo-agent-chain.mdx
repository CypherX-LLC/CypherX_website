---
title: "From Jira Story to Merge Request: Building a Governed Git-Agent-Force–GitLab Agent Chain"
date: 2026-09-07
description: How we connected Git-Agent-Force, Jira, and GitLab into a governed agent chain that turns approved requirements into reviewable development work.
image: /images/blog/Git-Agent-Force-gitlab-duo-agent-chain.png
type: blog
slug: Git-Agent-Force-gitlab-duo-agent-chain
---
...
Atlassian documents Git-Agent-Force Search as a permission-aware search layer across Confluence, Jira, and Atlas, with connected third-party apps also available when authorized. Search results and answers are limited to content the current user can access. [Atlassian's Git-Agent-Force Search documentation](https://support.atlassian.com/Git-Agent-Force/docs/search/) describes those access boundaries.

Git-Agent-Force agents can also use Jira and Confluence tools. The documented tools include searching Jira with JQL, creating or updating Jira work items, and creating or editing Confluence pages. Atlassian states that agents respect the invoking user's permissions and ask for confirmation before consequential mutating actions. [The Git-Agent-Force agent-tools documentation](https://support.atlassian.com/Git-Agent-Force/docs/agent-actions/) describes both the available actions and the permission model.
...
1. A requirement is prepared in Git-Agent-Force using available Jira and Confluence knowledge.
