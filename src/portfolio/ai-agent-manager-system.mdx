---
title: "Multi AI Agent Orchestrator"
...
## Project: Multi AI Agent Orchestrator
...
Build a Manager AI Agent (Router) and Specialist AI Agents system that could break down requests, delegate work, verify results, and keep a durable task history.
