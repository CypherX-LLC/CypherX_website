...
These are project requirements for the demo, not claims about a particular customer's production system. They create enough variety to test constraints, behavior, verification, and change impact.
